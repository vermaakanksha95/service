...
<div class=" flex p-10 gap-5">
    <div class=" w-4/12">
        ...
        <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
            <form class="space-y-6" action="{{route('cabs.store')}}" method="post">
                @csrf
                ...
                <div>
                    <label for="cab seat" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cab Seat</label>
